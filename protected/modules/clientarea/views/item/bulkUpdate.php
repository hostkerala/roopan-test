...
<?php $form = $this->beginWidget('application.modules.clientarea.widgets.ClientActiveForm', array(
    ...
    <?php foreach($items as $item_id => $item): ?>
        ...
        <div class="add-form">
            <?php $this->renderPartial('_form_fields', array('form' => $form, 'model' => $item, 'client' => $clients[$item_id], 'controls' => false, 'additional_data' => $additional_data[$item_id], 'category' => $item->category)); ?>
