...
<div class="form-wrap form-horizontal item_form_<?php echo $model_id; ?>">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model, 'item_nova_time', array('class' => 'control-label')); ?>
                <?php echo $form->datePickerField($model, 'item_nova_time', array('required' => true)); ?>
                <?php echo $form->error($model, 'item_nova_time'); ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model, 'item_back_amount'); ?>
                <?php echo $form->numberField($model, 'item_back_amount', array('required' => true, 'step' => '0.01', 'min' => 0, 'class' => 'form-control')); ?>
                <?php echo $form->error($model, 'item_back_amount'); ?>
            </div>
        </div>
    </div>
